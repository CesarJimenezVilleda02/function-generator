...
class OpenAIFunctionGenerator extends FunctionGenerationStrategy {
  constructor(builder) {
    super();
    this.apiKey = builder.apiKey;
    this.model = builder.model || 'gpt-4';
  ...
  async sendRequest(model, message) {
    ...
    if (!json.choices || json.choices.length === 0) {
      throw new Error('OpenAI API error: Response contained no choices');
    }
...
module.exports = OpenAIFunctionGenerator;
